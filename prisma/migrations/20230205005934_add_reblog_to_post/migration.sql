...
INSERT INTO "new_Post" ("content", "createdAt", "favoritesCount", "id", "profileId", "reblogsCount", "repliesCount", "updatedAt") SELECT "content", "createdAt", "favoritesCount", "id", "profileId", "reblogsCount", "repliesCount", "updatedAt" FROM "Post";
DROP TABLE "Post";
