...
INSERT INTO "new_Profile" ("avatarId", "createdAt", "domain", "followersCount", "followingCount", "headerId", "id", "name", "summary", "updatedAt", "userId", "username") SELECT "avatarId", "createdAt", "domain", "followersCount", "followingCount", "headerId", "id", "name", "summary", "updatedAt", "userId", "username" FROM "Profile";
DROP TABLE "Profile";
